...
/// <summary>
/// This script is for handling taking in files and spitting out textures or sprites
/// </summary>
public static class IMG2Sprite
{
    ...
    public static Sprite LoadSprite(string FilePath)
    {
        ...
        Texture2D rawTex = Resources.Load<Texture2D>(FilePath);
        Sprite NewSprite = ConvertTextureToSprite(rawTex);
